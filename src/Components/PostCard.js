    ...
    <Card>
      <div className="flex gap-3">
        ...
        <div className="grow">
          <p>
            ...
            shared a<a className="text-socialBlue ml-1">post</a>
          </p>
          <p className="text-gray-500 text-sm">2 hours ago</p>
        </div>
        <div>
          <button
            className="text-gary-400 "
            onClick={() => {
      ...
      <div className="">
        <p className="my-3 text-sm ">
          ...
          quos fugit tempora eius delectus possimus eum sint accusamus
          exercitationem?
        </p>
        <div className="rounded-md overflow-hidden flex items-center">
          <img
            src="https://images.unsplash.com/photo-1533105079780-92b9be482077?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80"
            alt=""
          />
        </div>
      </div>
      <div className="mt-5 flex gap-8">
        ...
        <button className="flex gap items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div className="flex mt-4 gap-3">
        ...
        <div className="border grow rounded-full relative">
          <textarea
            className="p-3 px-4 w-full block h-12 overflow-hidden rounded-full"
